...
type ShippingService interface {
	...
	// 如下定义一个获取已有仓库的函数
	GetConsignment(ctx context.Context, in *Getmessage, opts ...client.CallOption) (*Response, error)
}
...
func (c *shippingService) GetConsignment(ctx context.Context, in *Getmessage, opts ...client.CallOption) (*Response, error) {
...
type ShippingServiceHandler interface {
	...
	// 如下定义一个获取已有仓库的函数
	GetConsignment(context.Context, *Getmessage, *Response) error
}
...
func RegisterShippingServiceHandler(s server.Server, hdlr ShippingServiceHandler, opts ...server.HandlerOption) {
	type shippingService interface {
		...
		GetConsignment(ctx context.Context, in *Getmessage, out *Response) error
	}
	type ShippingService struct {
		shippingService
	}
...
func (h *shippingServiceHandler) GetConsignment(ctx context.Context, in *Getmessage, out *Response) error {
